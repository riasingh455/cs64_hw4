...
swap:
        ...
        addu $t3, $t0, $t1    # myArray[x]
        lw $t4, 0($t3)        # t4 is temp = myArray[x]

        addu $t5, $t0, $t2    # t6 is same thing but for y
        lw $t6, 0($t5)        
        ...
        addiu $t1, $t1, 8 //bytes to move to next index   
        addiu $t2, $t2, 8    
